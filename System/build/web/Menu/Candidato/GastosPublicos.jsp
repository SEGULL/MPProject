...
<td> <input type="text"  name="nombres"  value="Nombre o Razon Social"/>
    <input type="text"  name="numero" size="6" text-transp="uppercase"  value="N°" maxlength="10"/> 
...
<td>     
    ...
    <input type="text"  name="numero" value="N°" size="8" />
</td>
</tr>
...
<td> 
Efectivo<input type="radio" name="financiamiento" value="1"  />
