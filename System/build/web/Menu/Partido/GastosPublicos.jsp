...
<table>
<tr>
<td colspan="3"   >Formato de Gastos En Publicidad</td>
</tr>
...
<td>
    <input type="text"  name="nombres"  value="Nombre O Razon Social" size="20"/>
...
<td>
   <textarea type="text" name="Especificaciones" rows="4" value="---Especificaciones---" cols="20">Especificaciones...</textarea>
</td>
</tr>
